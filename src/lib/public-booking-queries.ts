...
export const publicBookingKeys = {
  ...
  slots: (slug: string, serviceId: string, date: string, providerId?: string | null) =>
    ["public", "available_slots", slug, serviceId, date, providerId ?? ""] as const,
  providers: (slug: string, serviceId: string) =>
    ["public", "booking_providers", slug, serviceId] as const,
};
